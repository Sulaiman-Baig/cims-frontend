...
@Component({
    selector: 'app-todays-followup',
    templateUrl: './todays-followup.component.html',
    styleUrls: ['./todays-followup.component.scss'],
...
export class TodaysFollowupComponent implements OnInit {
    ...
    ngOnInit(): any {
        ...
        this.enquiryService.getAllFollowUpInquiriesByCampus( this.campusId).subscribe((enqRes: Enquiry[]) => {
            if (enqRes.length === 0) {
                this.matSnackBar.open('No Today\'s Followup Enquiry Found', null, {
                    duration: 3000
                });
            }
