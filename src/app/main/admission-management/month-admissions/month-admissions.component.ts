...
@Component({
    selector: 'app-month-admissions',
    templateUrl: './month-admissions.component.html',
    styleUrls: ['./month-admissions.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class MonthAdmissionsComponent implements OnInit {
    ...
    ngOnInit(): any {
        ...
        this.admissionService.getAllThisMonthsAdmissionsByCampus(this.campusId).subscribe((admnRes: Admission[]) => {
            if (admnRes.length === 0) {
                this.matSnackBar.open('No Admissions Found In This Month', null, {
                    duration: 3000
                });
            }
