...
export class CreateAdmissionDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<CreateAdmissionDialogComponent>
    ) { }
    ...
    ngOnInit(): any {
        ...
        this.personalinfo = this._formBuilder.group({
            ...
            nic: ['', [Validators.required, Validators.pattern('^[0-9]*$')]],
            gender: ['', Validators.required],
            nationality: ['', Validators.required],
            personal_contact: ['', [Validators.required, Validators.pattern('^[0-9]*$')]],
            guardian_contact: ['', [Validators.required, Validators.pattern('^[0-9]*$')]],
            email: ['', [Validators.required, Validators.email]],
            postal_address: ['', [Validators.required]]

        });

        this.academicinfo = this._formBuilder.group({

            certificate1: [''],
            institute1: [''],
            year1: ['', [Validators.pattern('^[0-9]*$')]],
            percentage1: [''],

            certificate2: [''],
            institute2: [''],
            year2: ['', [Validators.pattern('^[0-9]*$')]],
            percentage2: [''],

            certificate3: [''],
            institute3: [''],
            year3: ['', [Validators.pattern('^[0-9]*$')]],
            percentage3: ['']
        });
    ...
    close(): void {
        this.router.navigate(['/admission/all']);
    }
    ...
    onCreateAdmission(): void {
        ...
        const personalinfodata = this.personalinfo.getRawValue();
        this.months(personalinfodata.dob._i.month);
        this.admission.student_name = personalinfodata.student_name;
        this.admission.guardian_name = personalinfodata.guardian_name;
        this.admission.dob =
            personalinfodata.dob._i.year
            + '/' +
            this.month
            + '/' +
            personalinfodata.dob._i.date;
        this.admission.nic = personalinfodata.nic;
        this.admission.gender = personalinfodata.gender;
        this.admission.nationality = personalinfodata.nationality;
        this.admission.personal_contact = personalinfodata.personal_contact;
        this.admission.guardian_contact = personalinfodata.guardian_contact;
        this.admission.email = personalinfodata.email;
        this.admission.postal_address = personalinfodata.postal_address;
        const academicinfodata = this.academicinfo.getRawValue();

        const student_academic_record = [
            {
                certificate: academicinfodata.certificate1,
                institute: academicinfodata.institute1,
                year: academicinfodata.year1,
                percentage: academicinfodata.percentage1
            },
            {
                certificate: academicinfodata.certificate2,
                institute: academicinfodata.institute2,
                year: academicinfodata.year2,
                percentage: academicinfodata.percentage2
            },
            {
                certificate: academicinfodata.certificate3,
                institute: academicinfodata.institute3,
                year: academicinfodata.year3,
                percentage: academicinfodata.percentage3
            }
        ];
        this.admission.student_academic_record = student_academic_record;
        ...
        this.admissionService.createAdmission(this.admission).subscribe((admRes: any) => {
            console.log(admRes);
            this.selectcourse.reset();
            this.personalinfo.reset();
            this.academicinfo.reset();
            this.forofficeuse.reset();
            this.dialogRef.close();
            this.ngOnInit();
            this.matSnackBar.open('Admission Created Successfully', null, {
