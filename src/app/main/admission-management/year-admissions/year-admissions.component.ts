...
@Component({
    selector: 'app-year-admissions',
    templateUrl: './year-admissions.component.html',
    styleUrls: ['./year-admissions.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class YearAdmissionsComponent implements OnInit {
    ...
    ngOnInit(): any {
        ...
        this.admissionService.getAllThisYearsAdmissionsByCampus(this.campusId).subscribe((admnRes: Admission[]) => {
            if (admnRes.length === 0) {
                this.matSnackBar.open('No Admissions Found In This Year', null, {
                    duration: 3000
                });
            }
