...
@Component({
    selector: 'app-ended-batch',
    templateUrl: './ended-batch.component.html',
    styleUrls: ['./ended-batch.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class EndedBatchComponent implements OnInit {
    ...
    ngOnInit(): any {
        ...
        this.batchService.getAllEndedBatchesByCampus(this.campusId).subscribe((batchRes: Batch[]) => {
            if (batchRes.length === 0) {
                this.matSnackBar.open('No Ended Batch Found', null, {
                    duration: 3000
                });
            }
